...
ADDITIONAL ANALYSIS OF THIS MODEL INCLUDING ROC-AUC, PSEUDO-R^2, CONFUSION MATRIC, ETC.
...
The final model for backwards selection was: 

The final model for forward selection was: 
