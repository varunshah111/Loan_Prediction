...
qqnorm(not_defaulted$Age, main="Q-Q plot of Age level of Not Defaulted Customers") 
qqline(not_defaulted$Age)
...
ggplot(data=not_defaulted, aes(Income)) + 
  geom_histogram(aes(y=..density..), col="aquamarine4", 
                 fill="aquamarine2", 
                 alpha = .7) +
...
qqnorm(not_defaulted$Income, main="Q-Q plot of Income level of Not Defaulted Customers") 
qqline(not_defaulted$Income)
```
...
#qqnorm(not_defaulted$Experience, main="Q-Q plot of Experience level of Not Defaulted Customers") 
#qqline(not_defaulted$Experience)
...
ggplot(data=not_defaulted, aes(CURRENT_HOUSE_YRS)) + 
  ...
  labs(title="Non-defaulted Customers ExperienceHistogram") +
  labs(x="House_Ownership", y="Frequency") 

ggplot(not_defaulted, aes(y=CURRENT_HOUSE_YRS)) + 
  geom_boxplot() + 
  geom_boxplot( colour="orange", fill="#7777cc", outlier.colour="red", outlier.shape=8, outlier.size=4) +
  labs(title="Not_Defaulted Customer House_Ownership boxplot ",x="", y = "weight (lbs)")


qqnorm(not_defaulted$CURRENT_HOUSE_YRS, main="Q-Q plot of Current House Years level of Not Defaulted Customers") 
qqline(not_defaulted$CURRENT_HOUSE_YRS)
...
ggplot(data=not_defaulted, aes(CURRENT_JOB_YRS)) + 
  geom_histogram(aes(y=..density..), binwidth = 1,
                 ...
                 fill="green", 
                 alpha = .7) + 
  labs(title="Non-defaulted Job years Histogram") +
...
ggplot(not_defaulted, aes(y=CURRENT_JOB_YRS)) + 
  geom_boxplot() + 
  geom_boxplot( colour="orange", fill="#7777cc", outlier.colour="red", outlier.shape=8, outlier.size=4) +
  labs(title="Not_Defaulted Job years Customer boxplot ",x="", y = "weight (lbs)")


qqnorm(not_defaulted$CURRENT_JOB_YRS, main="Q-Q plot of Job Years level of Not Defaulted Customers") 
qqline(not_defaulted$CURRENT_JOB_YRS)
...
qqnorm(defaulted$Age, main="Q-Q plot of Age Defaulted Customers") 
qqline(defaulted$Age)
...
ggplot(data=defaulted, aes(Experience)) + 
  geom_histogram(binwidth = 1,
                 ...
                 fill="green", 
                 alpha = .7) + 
  labs(title="defaulted Experience Age Histogram") +
  labs(x="Experience", y="Frequency") 
...
```
Based on the Two Sample T-test of the incomes of Defaulted and Not-defaulted customers, we cannot reject the $H_0$: $\mu_{defaulted} \geq \mu_{not defaulted}$ ,meaning the average incomes of defaulted v not-defaulted customers is approximatel the same. 
