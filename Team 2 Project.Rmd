...
```
Based on the Two Sample T-test of the incomes of Defaulted and Not-defaulted customers, we cannot reject the $H_0$: $\mu_{defaulted} \geq \mu_{not defaulted}$ ,meaning the average incomes of defaulted v not-defaulted customers is approximately.
